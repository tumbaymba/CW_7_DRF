...
Установить (если уже не установлен) Docker и Docker Compose.
Собрать и запустить контейнеры Docker (ocker-compose build).
Перейти по адресу http://localhost:8000 для доступа к проекту.
